...
class GraphService:
    ...
    def create_node(self, title: str, body: str | None = None) -> dict:
        ...
        return db.create_node(str(uuid.uuid4()), title, body)
    ...
    def create_edge(
        ...
        try:
            ...
            raise ValueError("An edge already exists between these two nodes.")
